...
export default function Index() {
	return (
		<div className="my-36">
			<div className="max-w-xl mx-auto flex flex-col items-center rounded-3xl bg-muted p-12">
				...
				<div className="flex flex-col items-center">
					<div className="flex flex-wrap items-center justify-center gap-4">
						<h1 className="text-center text-h2">Johnny McTailwind</h1>
					</div>
					<p className="mt-2 text-center text-muted-foreground">
						Joined 10/31/2023
					</p>
					<p className="text-lg text-center text-foreground mt-1">
					...
					<Link
						to="#"
						className="mt-3 inline-flex items-center justify-center rounded-md text-sm font-medium ring-offset-background transition-colors outline-none focus-visible:ring-4 focus-within:ring-4 ring-ring ring-offset-2 disabled:pointer-events-none disabled:opacity-50 text-primary underline-offset-4 hover:underline px-12 py-3 leading-3"
					>
